    ...
    <footer className="bg-[var(--brand-green)] text-[var(--text-on-brand)]">
      <div className="mx-auto max-w-[1280px] px-6 py-16 lg:px-12">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="max-w-xs text-sm leading-relaxed text-white/70">
              Precision depaneling solutions for PCB manufacturing.
              Official MSTECH partner in Brazil and Argentina.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/80">
              ...
              <li><a href="/catalog/others" className="hover:text-white">Others & Support</a></li>
            </ul>
          </div>
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-white/10 pt-6 text-xs text-white/50 md:flex-row md:items-center md:justify-between">
          <span>© {new Date().getFullYear()} SMTS · All rights reserved.</span>
          <span>
            MSTECH product information ©{" "}
            <a href="https://www.mstechcorp.kr" target="_blank" rel="noopener" className="hover:text-white">
              mstechcorp.kr
            </a>
          </span>
        </div>
